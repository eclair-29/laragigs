...
<x-card class="p-10 w-11/12 max-w-2xl mx-auto mt-12">
  <header class="text-center">
    ...
    <p class="mb-4">Edit the opened position for {{$listing->title}} for {{$listing->organization}}</p>
  </header>
  ...
  <form action="/listings/{{$listing->id}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-4">
      ...
      <input type="text"
        ...
        name="organization" value="{{$listing->organization}}" />
    ...
    <div class="mb-4">
      ...
      <img class="hidden h-32 w-auto mt-2 md:block"
